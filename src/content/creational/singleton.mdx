...
<Callout type="pitfall" title="Singleton is often a smell, not a solution">
...
- <a href={withBase('/fundamentals/dependency-injection/')}>Dependency Injection</a> is the usual alternative when
