...
<Callout type="pitfall" title="One class, three reasons to change">
...
- See also <a href={withBase('/fundamentals/cohesion-and-coupling/')}>Cohesion and Coupling</a> for the underlying theory.
